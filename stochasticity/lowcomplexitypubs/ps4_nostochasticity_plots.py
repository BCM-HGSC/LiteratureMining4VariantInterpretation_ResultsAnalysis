...
def main():
    ...
    ap.add_argument("--per", default=str(output_dir / "nostochasticity_only_per_pmid.csv"), help="per-PMID CSV")
    ap.add_argument("--summary", default=str(output_dir / "nostochasticity_only_summary_by_model.csv"), help="by-model summary CSV")
    ap.add_argument("--prefix", default=str(output_dir / "ps4_nostochasticity"), help="output filename prefix")
    args = ap.parse_args()
    ...
    core_palette = plt.get_cmap("Blues")(np.linspace(0.25, 0.85, 3))
